...
const publishedBlogsSchema = mongoose.Schema({
    title: {
        type: String,
...
const PublishedBlogsSchema = mongoose.model('PublishedBlog', publishedBlogsSchema)
module.exports = PublishedBlogsSchema